...
Call log:
  - waiting for locator('//label[text()="1234567890"]//preceding-sibling::input')
        ...
        - iframe [ref=f8e5]:
          - generic [ref=f12e2] [cursor=pointer]:
            - generic:
              - img "OUT NOW"
            - generic:
              - img "Visit TouchedByGold.com"
            - generic:
              - img "Logo smallest 40px height 60px with border"
            - generic:
              - img "EJ Lock Up"
            - generic:
              - img "Rectangle 623"
            - generic:
              - img "Main background KV"
            - generic:
              - img "wgc_Touched-by-gold_300x250_KV-Bars"
        - generic [ref=f8e6]:
          - generic:
