...
```ts
  ...
  12 |     this.page = page;
  13 |     this.expandAllButton = page.locator("xpath=//span[@class='rc-tree-switcher rc-tree-switcher_close']");
  14 |     this.collapseAllButton = page.locator("xpath=//span[@class='rc-tree-switcher rc-tree-switcher_open']");
