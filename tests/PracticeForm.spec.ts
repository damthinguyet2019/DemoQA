...
import {Utils} from '../common/Utils.js/';// khai bao de doc csv
const csvData = await readDataFromCSV(process.cwd() + "/testcase/data/" + 'PracticeForm_TC1.csv')
...
test.describe("Practice Form Test", () => {
  ...
  test("TC01 - Submit Data successfully", async () => {
    ...
    const dateOfBirth: string = "15 January 2000";
